...
const Footer = () => {
  return (
    <footer className="bg-white border-t border-gray-300 py-4 xs:mt-2 pb-20">
      <div className="container mx-auto items-center">
        <h1 className="text-base font-semibold text-red-500 py-2">
          Developer Contact
        </h1>
        ...
        <p className=" xs:text-base md:text-sm  my-2 text-gray-600">
