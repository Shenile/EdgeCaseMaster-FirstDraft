...
export default function WorkSpace() {
    ...
    return (
        <div className="flex flex-col h-full py-2">
            ...
            <div className="flex flex-col md:flex-row gap-2 items-center justify-center px-4 h-full overflow-hidden">
                <div className='px-4 py-4 w-full md:w-1/2 flex flex-col gap-4 border border-gray-300 rounded-md h-full'>
                    <div className='px-2 flex flex-col h-full overflow-hidden'>
                ...
                <div className='w-full md:w-1/2 h-full flex flex-col border border-gray-300 rounded-md overflow-hidden'>
                    <DisplayArray
                        inputCollection={inputCollection}
                        outputCollection={outputCollection}
